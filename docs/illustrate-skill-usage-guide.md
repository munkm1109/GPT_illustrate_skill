...
SPEC file
  ...
  └─ contains final IMAGE_GEN_HANDOFF_PROMPT
```
...
이 단계가 통과해야 `IMAGE_GEN_HANDOFF_PROMPT`를 image generation으로 넘긴다.
...
4. 원본 오브젝트의 정체성을 유지한 채 스타일만 번역한다.
